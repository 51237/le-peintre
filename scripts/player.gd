...
func _on_arduino_button_event(button_name: String, pressed: bool) -> void:
	if not pressed:
		match button_name:
			"button1": pressed_buttons.erase(0)
			"button2": pressed_buttons.erase(1)
			"button3": pressed_buttons.erase(2)
		return
	match button_name:
		"button1": _press_button(0)
		"button2": _press_button(1)
		"button3": _press_button(2)
		"button4": _simple_attack()
